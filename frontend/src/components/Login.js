...
const HomeContainer = styled.div`
  position: relative;
  min-height: 100vh;
  background: url('https://en-ac-illust.com/materials/24693406/preview.png') center center / cover no-repeat;
  display: flex;
  align-items: center;
...
const Card = styled.div`
  background: rgba(30, 41, 59, 0.95); /* dark navy */
  border-radius: 20px;
  padding: 40px 36px;
  width: 100%;
  max-width: 460px;
  ...
  return (
    <HomeContainer>
      <Card>
        ...
        <Subtitle>Visualize. Collaborate. Innovate.</Subtitle>
